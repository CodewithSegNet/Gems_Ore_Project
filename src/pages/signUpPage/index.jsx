...
const SignUpPage = () => {
  ...
  // Steps: 1 = Create Account, 2 = Verify OTP, 3 = Resend OTP
  ...
  const handleVerifyOtp = (e) => {
    e.preventDefault();
    alert("Account Created! (replace with real auth)");
  };
      ...
      <div className="relative z-10 w-[90%] max-w-[540px] bg-white rounded-md shadow-2xl overflow-hidden">
        ...
        <div className="px-8 pb-8">
          ...
          {step === 2 && (
            <>
              <div className="text-left mb-6">
                <h2 className="text-xl font-bold text-[rgba(68,68,68,1)]">Verify your email</h2>
                <p className="text-sm text-gray-400 mt-1">
                  A 6-digit OTP was sent to <span className="font-medium text-[rgba(68,68,68,1)]">{email}</span>, enter OTP to create your account
                </p>
              </div>
