              ...
              <form onSubmit={handleCredentialsSubmit}>
                ...
                <div className="mb-5">
                  <div className="flex items-center gap-1 w-full px-4 py-4 border border-gray-200 bg-gray-200 rounded-md focus-within:border-[rgba(88,57,49,1)] transition-colors duration-200">
                    ...
                    <input type={showPassword ? "text" : "password"} value={password} onChange={(e) => setPassword(e.target.value)} placeholder="enter your password" required minLength={6} className="flex-1 bg-transparent outline-none text-sm text-[rgba(68,68,68,1)] placeholder:text-[rgba(68,68,68,0.5)]" />
