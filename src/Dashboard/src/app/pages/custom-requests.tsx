...
import { mockCustomRequests, CustomRequest } from "../utils/mock-data";
...
export function CustomRequests() {
  const [requests, setRequests] = useState<CustomRequest[]>(() => {
    ...
    return stored ? JSON.parse(stored) : mockCustomRequests;
  });
  ...
  useEffect(() => {
    localStorage.setItem('gemsore_custom_requests', JSON.stringify(requests));
  }, [requests]);
  ...
  const handleStatusChange = (requestId: string, newStatus: 'pending' | 'contacted' | 'completed') => {
          ...
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div className="flex gap-2">
              <Button
                ...
                className={filterStatus === 'all' ? 'bg-black hover:bg-slate-800' : ''}
              >
              ...
              {filteredRequests.length === 0 ? (
                ...
                filteredRequests.map((request) => (
                  <TableRow key={request.id} className="border-slate-100">
                    ...
                    <TableCell className="font-medium text-slate-900">{request.fullName}</TableCell>
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="font-mono text-sm font-medium text-slate-900">{selectedRequest.id}</p>
                </div>
                <div>
